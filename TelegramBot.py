...
async def start(msg: Message):
    ...
    await msg.answer("Привет 👋 \nЯ - телеграм бот для ютубера Dalmee. Я буду отправлять тебе уведомления о выходе новых роликов, а также ты можешь посмотреть все вышедшие на данный момент видео с помощью команды /videos!")
